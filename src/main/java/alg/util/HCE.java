...
public class HCE {
   ...
   */
  public HCE(double[][] delta, double[][] etc) {
    this.delta = delta;
    this.etc = etc;
   ...
   */
  public HCE(double[][] delta, double[][] etc, double[][] commCost) {
    this.delta = delta;
    this.etc = etc;
   ...
   * 
   * @param SA simulated annealing object
   */
  public void setSimulatedAnnealing(SimulatedAnnealing SA) {
    this.SA = SA;
  }
